...
const SelectLanguagePage: FC<SelectLanguagePageProps> = ({ intl }) => {
  ...
  const buttonStyle =
    'col-span-1 flex w-full flex-col place-content-center items-center mb-8';
  const imageStyle =
  ...
  return (
    <div className="grid grid-cols-2 place-content-center">
      ...
      <button onClick={() => handleChange('de')} className={buttonStyle}>
        <Image
      ...
      <button onClick={() => handleChange('es')} className={buttonStyle}>
        <Image
          src="/spain-flag.svg"
          alt="Spanish"
          width={500}
      ...
      <button onClick={() => handleChange('it')} className={buttonStyle}>
        <Image
          src="/italy-flag.svg"
          alt="Italian"
          width={500}
      ...
      <button onClick={() => handleChange('fr')} className={buttonStyle}>
        <Image
          src="/france-flag.svg"
          alt="Frensh"
          width={500}
      ...
      <button onClick={() => handleChange('pt')} className={buttonStyle}>
        <Image
          src="/brazil-flag.svg"
          alt="Portuguese"
          width={100}
